                        ...
                        <div class="cart-form table-responsive">
                                ...
                                <asp:ListView ID="LstCart" runat="server">
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td class="sop-cart"> <asp:ListView ID="lstgallery" runat="server" DataSourceID="sqlprice">
                                                <ItemTemplate>
                                                   ₹<asp:Label ID="LblTotalAmount" runat="server" Text='<%# Eval("Price") %>'></asp:Label>
                                                   
                                                </ItemTemplate>
                                            </asp:ListView> </td> 
                                            <td class="sop-cart"> <asp:ListView ID="ListView2" runat="server" DataSourceID="sqlprice">
                                                <ItemTemplate>
                            ...
                            UpdateCommand=" ">
                                        ...
                                        <asp:ControlParameter Name="productid" ControlID="productid" Type="Int32" />
                                             ...
                                             <td class="sop-cart">
                                                <asp:ListView ID="ListView1" runat="server" DataSourceID="sqlmain">
                                                <ItemTemplate>
                            ...
                            <div class="a-all ">
                                ...
                                <div class="a-right">
                                    <button class="button2 notice Estimate" title="" type="button"  onclick="window.location='Cart.aspx';">
            ...
            <div class="cart-collaterals row" style="margin-top: -75px">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="totals">
                        ...
                        <button class="button2 get" title="" type="button"  onclick="window.location='Productorder.aspx';">
