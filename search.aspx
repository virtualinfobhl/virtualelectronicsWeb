            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        ...
                        <div class="narrow-by-list" runat="server" visible="false">
                                ...
                                <div class="odd">
                                    <ul>
                                      <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSource1">
                                            <ItemTemplate>
                                                <li>
                                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("MainCategoryid") %>' OnClick="LinkButton1_Click2"><%# Eval("MainCategoryName") %></asp:LinkButton></li>
                                            </ItemTemplate>
                                        </asp:ListView>
                            ...
                            <div class="block layered-attribute">
                                ...
                                <div class="odd">
                                    <ul>
                                        ...
                                        <li>
                                            <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument="2" OnClick="LinkButton2_Click">Price Heigh to Low</asp:LinkButton></li>
