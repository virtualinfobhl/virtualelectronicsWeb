<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AgentRegister.aspx.cs" Inherits="AgentRegister" %>
                ...
                <div class="col-sm-5 col-md-5 col-lg-5">
                    <form>
                        <div class="form-group">
                            <asp:TextBox ID="Txtname" runat="server" class="form-control" placeholder="Enter Agent Name" TabIndex="1"></asp:TextBox>
                        </div>
                        <div class="form-group">
