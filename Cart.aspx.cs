...
public partial class Cart : System.Web.UI.Page
{
   ...
   public static int TotAmt = 0, Realprice = 0, totaldis = 0;
    ...
    {
        string Sql = "select a.id,a.productid,a.color,a.Size,b.productname,a.Quantity,b.image from trncart as a inner join  product as b on a.productid=b.productid ";
        string Sql_Inner = "";
        ...
        if (Sql_Inner != "")
        {
            ...
            for (int i = 0; i < LstCart.Items.Count; i++)
            {
                ...
                LblTotalAmoun111t.Text =Cnn.ExecuteScalar("select (urate*" + DDQty.SelectedValue + ") as urate from ProductSizeQuantity  where ProductId='" + productid.Text + "' and Size='" + lblSize.Text + "' and colorid='" + lblcolor.Text + "'").ToString();
