...
public partial class DeliverdOrderList : System.Web.UI.Page
{
    public string DeliverdDate = "";
    public string DeliverdTime = "";
    ClsConnection Cnn = new ClsConnection();
    public string Cancelid; public string remark = "";
    ...
    public void list()
    {
        DataTable Dt = Cnn.FillTable("select e.firmname,a.Orderid,a.InvoiceNo,a.Name,a.City,a.MobileNo,convert(varchar, a.RTS, 0) as  Date,convert(varchar, a.RTS, 107) as  Time,a.OrderThrough,b.State_Name as State,a.TotalQuantity from [TrnOrderMain] as a inner join  M_StateMaster as b on a.StateCode=b.State_Code inner join Registration as e on a.Userid=e.userid where  a.Delivered=1 And a.Canceled=0  order by OrderId Desc", "ttt");
