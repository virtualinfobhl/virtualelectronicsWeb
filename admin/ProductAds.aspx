<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="ProductAds.aspx.cs" Inherits="ProductAds" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">Middle Ads Form </h1>
                </div>
            </div>
            <div class="row">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Eval("id") %>
                                                            ...
                                                            <td>
                                                                <img src="../img/Middleads/<%# Eval("image") %>" style="height: 80px; width: 150px; border: solid 1px #cccccc" />
                                                              <br />
