<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="OrderList.aspx.cs" Inherits="OrderList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <asp:ListView ID="LstActive" runat="server" OnItemCommand="LstActive_ItemCommand">
                                            <LayoutTemplate>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td style="width: 80px;">
                                                            <asp:LinkButton ID="LnkDispatch" Style="text-decoration: none;" runat="server" CommandName="Dispatch" ForeColor="Black">&nbsp;&nbsp;Disptach&nbsp;&nbsp;</asp:LinkButton>
                                                        </td>
                                                        <th>Order No.</th>
                                                        <th>Qty.</th>
                                                        <th>Date</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton ID="LinkButton1" CommandName="Del" runat="server">Cancel</asp:LinkButton><br />
                                                   <%--     <asp:LinkButton ID="LinkButton3" CommandName="print" runat="server">print</asp:LinkButton>--%>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:ListView>
    ...
    <script  type="text/javascript">
        function PrintMe(divid) {
            ...
            docprint.document.write("<link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\" type=\"text/css\" media=\"print\" />");
   ...
   <div id="divid">
                    ...
                    <div class="default">
                        ...
                        <table cellpadding="0" cellspacing="0" class="cart_in" style="border: 0px solid grey; width: 700px">
                            <tr style="border: solid 1px red; width: 700px;background-color:white">
                                ...
                                <td style="background-color: white; text-align: right;padding: 2px;">Phone :01482-248123,248124 <br />M :94138-84119</td>
                           </table> </tr>
                                    ...
                                    <table width="700px" cellpadding="0" cellspacing="0" border="0">
                                        <asp:ListView ID="LstCategory" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <table style="width:700px">
                                                    <tr>
                                                        <td style="border: solid 1px #cccccc">     <b>Order No</b> :  
                                                            <asp:Label ID="LblOrderNo" runat="server" Text='<%# Eval("InvoiceNo") %>'></asp:Label></td>
                                                        <td style="border: solid 1px #cccccc">    <b>Order Date</b> : 
                                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("Date") %>'></asp:Label> </td>
                                                        <td style="border: solid 1px #cccccc">   <b>Order Time.</b> :        
                                                            <asp:Label ID="Label7" runat="server" Text='<%# Eval("Time") %>'></asp:Label></td>
                                                    </tr>
                                                </table>
                                                <table style="width:700px">
                                                    <tr>
                                                        <td style="border: solid 1px #cccccc">  Party Name :<%# Eval("FirmName") %><br />
                                                            Agent Name :  <%# Eval("AgentName") %>   <br />
                                                        
                                                           GST IN : <%# Eval("Gst") %> <br/>  Email Id : <%# Eval("EmailId")%><br />
                                                             TransPort  Name: <%# Eval("TransPortName") %> <br />  Address :<%# Eval("Address") %><br />
                                                          Station :  <%# Eval("Station") %> City : <%# Eval("city") %></td>
                                                          <td style="border: solid 1px #cccccc"> 
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    GSTIN : <%# Eval("GstNo") %>
                                                                    <br />
                                                                  TransPort  Name: <%# Eval("TransPortName") %> <br/>   Station :<%# Eval("Station") %>
                                                                   <%-- <br />
                                                                  City :  <%# Eval("City") %>--%>
                                                                    <br />
                            ...
                            <tr>
                                <td>
                                    <table width="700px" cellpadding="0" cellspacing="0" class="cart_in">
                                        <tr>
                                            <td style="background-color: #fbbe77;">
                                                <asp:ListView ID="LstConferm" runat="server">
                                                    <LayoutTemplate>
                                                        <tr style="height: 25px; background-color: white; color: #000000; border-bottom: solid 0px #c8c5c5; border-top: solid 1px #c8c5c5" align="center">

                                                            <td style="width: 255px; border-right: solid 1px #c8c5c5">
                                                                <b>Particulars</b>
                                                            </td>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblOrderId" runat="server" Visible="false" Text='<%#Eval("OrderId") %>'></asp:Label>
                                                        <tr style="background-color: white; color: #535353; height: 30px; border: solid 1px #c8c5c5; border-top: solid 1px #c8c5c5">

                                                            <td style="width: 330px; text-align: center; border-right: solid 1px #c8c5c5; border-bottom: solid 1px #c8c5c5; padding-left: 3px;">
                                                                <asp:ListView ID="ListView3" runat="server" DataSourceID="Srcluggage">
                                                                    <ItemTemplate>
                                                                     <span style="font-size:10px"> <%# Eval("ProductName") %></span>  
                                                                    </ItemTemplate>
                                                                </asp:ListView>
                                                            ...
                                                            <td style="width: 275px; text-align: center; border-right: solid 1px #c8c5c5; border-bottom: solid 1px #c8c5c5; padding-left: 3px;">
                                                                ...
                                                                <asp:ListView ID="lstShadeid" runat="server" DataSourceID="SqlDataSource1">
                                                                    <ItemTemplate>
                                                                     <span style="font-size:10px"> <%# Eval("ShadeNo") %></span>  
                                                                    </ItemTemplate>
                                                                </asp:ListView>
                                                            </td>
                                                               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ShivShaktiSynthetics%>"
                                                                CancelSelectOnNullParameter="false" SelectCommand="select * from M_ShadeMaster  where ProductId=@ProductId and id=@lblShadeid">
                                                                <SelectParameters>
                                                            ...
                                                            <td style="width: 235px; text-align: center; border-right: solid 1px #c8c5c5; border-bottom: solid 1px #c8c5c5; padding-left: 3px;">
                                                                <asp:Label ID="lbltotalmeter" runat="server" Text='<%#  String.Format("{0:0.00}", Eval("TotalQuantity")) %>'></asp:Label>
                                                            ...
                                                            <td style="width: 225px; text-align: center; border-right: solid 1px #c8c5c5; border-bottom: solid 1px #c8c5c5; padding-left: 3px;">
                                        ...
                                        <tr style="height: 35px; background-color: white; color: #000000; border-bottom: solid 0px #c8c5c5; border-top: solid 1px #c8c5c5" align="center">
                                           ...
                                           Total Meter :   
                                            ...
                                            <td>  <asp:Label ID="lbltotalmeter" runat="server" ></asp:Label></td>
                                            <td></td>
                                        </tr>
                                    ...
                                    <table style="margin-top: 1px; border: solid 1px #c8c5c5; background-color: white" width="700px">
                                        <tr>
                                            <td>Remark : <asp:Label ID="lblremark" runat="server" ></asp:Label></td>
                                        </tr>
                                    </table>
                                      <table style="margin-top: 1px; border: solid 1px #c8c5c5; background-color: white;text-align:center" width="700px">
                                        <tr>
                                       <td>    <img src="../img/logo.jpg" style="height: 110px; width: 256px" /></td>
                                        </tr>
                                    </table>
    ...
    <asp:Panel ID="Printpanel" runat="server" Visible="false">
        ...
        <div id="div11" runat="server" style="padding-top: 20px; padding-bottom: 20px; padding-left: 100px;">
            <div class="default">
