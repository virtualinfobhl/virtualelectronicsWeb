                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                ...
                                <div class="form-group has-success">
                                    <label class="control-label" for="success">Brand Image (140*140)</label>

                                    <asp:FileUpload ID="FileUpload1" runat="server" />
                                    <asp:Image ID="Image1" runat="server" Style="height: 140px; width: 140px" Visible="false" />
                                </div>
                                        ...
                                        <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="../img/brand/<%# Eval("image") %>" style="height: 140px; width: 140px; border: solid 1px #cccccc" /></td>
