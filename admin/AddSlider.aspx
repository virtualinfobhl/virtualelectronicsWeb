<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddSlider.aspx.cs" Inherits="AddSlider" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">Slider  Forms </h1>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                ...
                                <div class="form-group has-success">
                                    <label class="control-label" for="success">Slider Photo Active(Only One Slider Photos Active)</label>
                                        ...
                                        <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <asp:Label ID="lbltitle" runat="server" Text='<%# Eval("active") %>' Visible="false"></asp:Label>
