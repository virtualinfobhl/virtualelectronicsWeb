<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="GalleryActive.aspx.cs" Inherits="ProductsActive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Active /Deactive  Gallery </h1>
                    </div>
                </div>
                <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <asp:ListView ID="LstActive" runat="server" OnItemCommand="ListView2_ItemCommand">
                                           ...
                                           <td>  
                                               <%-- <asp:CheckBox ID="ChkBox" runat="server" /><br />--%>
                                               <asp:LinkButton ID="LinkButton2" runat="server" CommandName="dea" Font-Bold="true" ForeColor="#3c8dbc">Deactive</asp:LinkButton></td>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <asp:ListView ID="LstDeactive" runat="server" OnItemCommand="ListView1_ItemCommand">
                                           ...
                                           <td>   
                                               <%--<asp:CheckBox ID="ChkBox" runat="server" /><br />--%>
                                               <asp:LinkButton ID="LinkButton2" runat="server" CommandName="active" Font-Bold="true" ForeColor="#3c8dbc">Active</asp:LinkButton></td>
