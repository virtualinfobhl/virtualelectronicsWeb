...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">Product Form </h1>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group has-success">
                                            <label class="control-label" for="success">Image 2 (500*500)</label><asp:FileUpload ID="FileUpload2" runat="server" />

                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group has-success">
                                            <label class="control-label" for="success">Image 3 (500*500)</label><asp:FileUpload ID="FileUpload3" runat="server" />

                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group has-success">
                                            <label class="control-label" for="success">Image 4 (500*500)</label><asp:FileUpload ID="FileUpload4" runat="server" />

                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group has-success">
                                            <label class="control-label" for="success">Image 5 (500*500)</label><asp:FileUpload ID="FileUpload5" runat="server" />

                                        </div>
                                    </div>
                                </div>

                                <asp:Button ID="Button1" runat="server" Class="btn-danger" Text="Add" Style="border-style: none; padding: 5px" OnClick="Button1_Click1" ValidationGroup="aaaa" />
                                                ...
                                                <asp:ListView ID="lstcolorlist" runat="server" OnItemCommand="lSTProducts_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <%--<asp:HiddenField ID="dtl_ProductGalleryid" runat="server" Value='<%# Eval("dtl_ProductGallery") %>' />--%>
