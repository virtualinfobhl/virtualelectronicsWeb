<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="WaitingUserList.aspx.cs" Inherits="WaitingUserList" %>
                                            ...
                                            <th>Name</th>
                                             ...
                                             <ItemTemplate>
                                                 <tr>
                                                     ...
                                                     <td><%# Eval("Username") %></td>
                                                     <td><%# Eval("Password") %></td>
                                                   <td>  <asp:CheckBox ID="ChkBox" runat="server" /> <br /> <span visible='<%# ((Convert.ToInt32(Eval("ActiveStatus")) >0) ? true : false) %>'  runat="server" style="font-size:10px;color:red">Deactive User</span></td>
