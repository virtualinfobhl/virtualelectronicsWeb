    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Button1.Text == "Update")
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                Bitmap bmpmain = imageHandler.CreateThumbnail(image, false, 870, 435);
                if (bmpmain != null)
                {
                ...
                Cnn.ExecuteNonQuery("update blog_detail set title='" + Txttitle.Text.Replace("'", "''") + "',image='" + filename + "',description='" + CKEditor1.Value + "' where id='" + LblId.Value + "' ");
                
            }
            else
            {

                Cnn.ExecuteNonQuery("update blog_detail set title='" + Txttitle.Text.Replace("'", "''") + "',description='" + CKEditor1.Value + "' where id='" + LblId.Value + "' ");
            }
